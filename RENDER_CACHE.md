...
Slow-motion video ranges retain the preceding decoded source frame and preserve the original clip timestamp origin before frame-rate conversion. Otherwise a range beginning between source frames could incorrectly advance the displayed image. Exact whole/range pixel regressions cover 24fps and 29.97fps sources at fractional speeds, and animation clips with trim/split/effect/transition edits match equivalent managed media.
