...
export function parseCaptions(text: string, format: CaptionFormat, trackId: string, fps: Rational, style: CaptionCue["style"]): CaptionCue[] {
...
export function serializeCaptions(captions: CaptionCue[], format: CaptionFormat): string {
