...
try{
 ...
 if(process.env.RUN_BROWSER_INTEGRATION==="1")await command(npm,["exec","--","vitest","run","tests/studio-browser.integration.test.ts","tests/export-browser.integration.test.ts","tests/video-mask-browser.integration.test.ts","tests/retiming-browser.integration.test.ts","tests/lut-browser.integration.test.ts","tests/core-editing-browser.integration.test.ts","tests/agent-editing-production.integration.test.ts","tests/audio-focus-browser.integration.test.ts"],{...process.env,RUN_FFMPEG_INTEGRATION:"1",STUDIO_TEST_ENTRY:entry});
