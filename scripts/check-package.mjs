...
try{
 ...
 if(process.env.RUN_BROWSER_INTEGRATION==="1")await command(npm,["exec","--","vitest","run","tests/studio-browser.integration.test.ts"],{...process.env,STUDIO_TEST_ENTRY:entry});
